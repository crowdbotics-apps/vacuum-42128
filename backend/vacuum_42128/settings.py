"""
Django settings for vacuum_42128 project.
...
ROOT_URLCONF = 'vacuum_42128.urls'
...
WSGI_APPLICATION = 'vacuum_42128.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "vacuum_42128 API",
    "DESCRIPTION": "API documentation for vacuum_42128 App",
    "VERSION": "v1",
}
